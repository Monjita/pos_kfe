            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($notas as $nota)
                    <tr class="bg-white even:bg-gray-50">
                        ...
                        <td class="text-center px-6 whitespace-nowrap text-sm text-gray-900">
                            {{ \Carbon\Carbon::parse($nota->fecha_doc)->translatedFormat('d/M/y') }}
                        </td>
                        ...
                        <td class="w-56 flex justify-center">
                            <div class="relative flex items-center group justify-center">
                                <a class="text-sm text-opacity-100 border border-transparent text-blue-500 hover:bg-blue-100 font-bold py-2 px-2 rounded-lg" target="_blank"
                                        href="{{ route('nota.ticket', $nota->id) }}" >
